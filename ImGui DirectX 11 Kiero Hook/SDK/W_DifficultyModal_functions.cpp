...
// const struct FGameplayTag&              DifficultyTag                                          (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, HasGetValueTypeHash)

void UW_DifficultyModal_C::OnButtonStateChanged(bool bEnabled, const struct FGameplayTag& DifficultyTag)
{
	static class UFunction* Func = nullptr;
	...
	Parms.DifficultyTag = std::move(DifficultyTag);
...
void UW_DifficultyModal_C::Reconfigure(bool IsHosting, bool FriendsOnly)
{
	static class UFunction* Func = nullptr;
