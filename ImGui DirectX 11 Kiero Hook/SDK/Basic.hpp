...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08F87F30;
	constexpr int32 AppendString      = 0x00CBD2C0;
	constexpr int32 GNames            = 0x08E86688;
	constexpr int32 GWorld            = 0x090F4AD8;
	constexpr int32 ProcessEvent      = 0x00E76210;
