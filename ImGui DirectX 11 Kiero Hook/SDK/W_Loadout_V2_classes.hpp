...
public:
	...
	TMap<class FName, class UFMODEvent*>          Page_to_FMOD_Tag_Map;                              // 0x0BF0(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FString                                 PresetToDelete;                                    // 0x0C40(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash)
